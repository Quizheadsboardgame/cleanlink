        ...
        <div className="space-y-16">
          ...
          <section className="space-y-8">
            <div className="flex items-center gap-3 justify-center sm:justify-start">
              <Badge variant="outline" className="border-lime-500/30 text-lime-400 px-3 py-1">GETTING STARTED</Badge>
              <h2 className="text-2xl font-bold font-headline">How to Submit</h2>
            </div>
            <div className="grid gap-6 sm:grid-cols-3">
              {steps.map((step, idx) => (
                <Card key={idx} className="glass-panel border-white/5 transition-all hover:border-lime-500/20">
                  <CardHeader>
          ...
          <section className="space-y-8">
            <div className="flex items-center gap-3 justify-center sm:justify-start">
              <Badge variant="outline" className="border-lime-500/30 text-lime-400 px-3 py-1">WHY USE CLEANLINK</Badge>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {benefits.map((benefit, idx) => (
                <Card key={idx} className="glass-panel border-white/5 p-6 flex gap-4">
                  <div className="bg-lime-500/10 p-3 rounded-full h-fit">
          ...
          {/* Emergency Info Box */}
          <Card className="guide-gradient border-none text-white p-8 rounded-3xl shadow-2xl relative overflow-hidden group">
