...
export const translations = {
  ...
  es: {
    ...
    common: { submit: "Enviar Ahora", loading: "Enviando...", site: "Tu Sitio", name: "Tu Nombre", date: "Fecha", back: "Atrás", error: "Algo salió mal", success: "¡Listo!", wait: "Un momento...", auth: "Conectando...", missingInfo: "Faltan detalles", emergency: "Si es una emergencia, llame a su jefe de inmediato.", select: "Seleccione...", downloadPdf: "Descargar PDF" },
  ...
  pt: {
    ...
    common: { submit: "Enviar Agora", loading: "Enviando...", site: "O seu Local", name: "O seu Nome", date: "Data", back: "Voltar", error: "Algo correu mal", success: "Pronto!", wait: "Um momento...", auth: "Ligando...", missingInfo: "Faltam detalhes", emergency: "Em emergência, ligue para o chefe já.", select: "Selecione...", downloadPdf: "Descarregar PDF" },
  ...
  pl: {
    ...
    hours: { title: "Dodatkowe Godziny", description: "Chcesz więcej zmian lub godzin w swojej lokalizacji?", requestType: "Czego szukasz?", permanent: "Stałe (co tydzień)", temporary: "Tymczasowe (tylko na kilka dni)", datesFree: "W jakie dni możesz pracować?", datesPlaceholder: "np. Poniedziałek - piątek w przyszłym tygodniu", timesAvailable: "W jakich godzinach?", timesPlaceholder: "np. 16:00 - 20:00", submit: "Wyślij Prośbę", successTitle: "Prośba Wysłane!", successDesc: "Dzięki! Sprawdzimy grafik i damy znać.", missingFields: "Powiedz nam, jakich godzin szukasz." },
  ...
  ro: {
    ...
    common: { submit: "Trimite", loading: "Se procesează...", site: "Locație", name: "Nume", date: "Dată", back: "Înapoi", error: "Eroare", success: "Succes", wait: "Așteptați o clipă", auth: "Autentificare...", missingInfo: "Informații lipsă", emergency: "Formularele vor fi revizuite în următoarea zi lucrătoare.", select: "Selectați...", downloadPdf: "Descărcați PDF" },
  ...
  hu: {
    ...
    common: { submit: "Küldés", loading: "Feldolgozás...", site: "Helyszín", name: "Név", date: "Dátum", back: "Vissza", error: "Hiba", success: "Siker", wait: "Pillanat", auth: "Hitelesítés...", missingInfo: "Hiányzó adatok", emergency: "A beküldött űrlapokat holnap bíráljuk el.", select: "Választás...", downloadPdf: "PDF Letöltése" },
  ...
  cs: {
    ...
    common: { submit: "Odeslat", loading: "Zpracování...", site: "Lokalita", name: "Jméno", date: "Datum", back: "Zpět", error: "Chyba", success: "Úspěch", wait: "Počkejte chvíli", auth: "Ověřování...", missingInfo: "Chybějící informace", emergency: "Odeslané formuláře budou zkontrolovány příští pracovní den.", select: "Vybrat...", downloadPdf: "Stáhnout PDF" },
    ...
    guide: { title: "Průvodce CleanLink", description: "Ovládněte systém správy s AI.", workflow: "Operační postup", capabilities: "Možnosti systému", benefits: "Výhody", emergencyTitle: "Link Offline?", emergencyDesc: "V nouzi volejte svého nadřízeného.", developer: "Vyvinuto Smart Harley Technology", resourcesTitle: "Digitální Centrum Zdrojů", cleanerGuideTitle: "Průvodce Úspěchem Pracovníka", cleanerGuideDesc: "Zjistěte, jak CleanLink usnadňuje vaše směny a pomáhá vám vydělávat více.", managerGuideTitle: "Manažerský Strategický List", managerGuideDesc: "Proč je CleanLink klíčový pro výkon lokality a správu týmu.", viewSheet: "Stáhnout PDF Průvodce" },
    sheetCleaner: {
  ...
  bg: {
    ...
    common: { submit: "Изпрати", loading: "Чакайте...", site: "Обект", name: "Име", date: "Дата", back: "Назад", error: "Грешка", success: "Успех", wait: "Момент", auth: "Проверка...", missingInfo: "Липси", emergency: "Преглед утре.", select: "Избор...", downloadPdf: "Изтегли PDF" },
  ...
  tr: {
    ...
    common: { submit: "Gönder", loading: "Bekleyin...", site: "Saha", name: "İsim", date: "Tarih", back: "Geri", error: "Hata", success: "Başarılı", wait: "An", auth: "Doğrulama...", missingInfo: "Eksik", emergency: "Yarın incelenir.", select: "Seç...", downloadPdf: "PDF İndir" },
    ...
    guide: { title: "Rehber", description: "Sipariş ve raporları kolayca yönetmeyi öğrenin.", workflow: "3 Basit Adım", capabilities: "Neler Yapılır", benefits: "Avantajlar", emergencyTitle: "Acil Yardım?", emergencyDesc: "Acil durumda amirinizi arayın.", developer: "Smart Harley Technology tarafından yapıldı", resourcesTitle: "Dijital Kaynak Merkezi", cleanerGuideTitle: "Temizlikçi Başarı Formu", cleanerGuideDesc: "CleanLink'in vardiyalarınızı nasıl kolaylaştırdığını ve daha fazla kazanmanıza nasıl yardımcı olduğunu öğrenin.", managerGuideTitle: "Yönetici Stratejik Formu", managerGuideDesc: "CleanLink'in saha performansı ve ekip yönetimi için neden kritik olduğunu öğrenin.", viewSheet: "PDF Rehberi İndir" },
    sheetCleaner: {
