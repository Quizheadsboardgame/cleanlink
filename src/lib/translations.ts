export const translations = {
  en: {
    ...
    clocking: {
      ...
      locationRequired: "GPS coordinates are required to clock in/out.",
      outOfRange: "Coordinates recorded for your session.",
    ...
    incomplete: {
      ...
      areaPlaceholder: "e.g. Whole office, Section B, or Part of canteen",
    ...
    guide: {
      ...
      resourcesTitle: "Digital Resource Centre",
  ...
  es: {
    ...
    clocking: {
      ...
      locationRequired: "Se requieren coordenadas GPS.",
      outOfRange: "Coordenadas registradas.",
